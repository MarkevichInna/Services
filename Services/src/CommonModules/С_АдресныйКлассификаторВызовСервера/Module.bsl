...
Функция ПроверитьОбновлениеАдресныхОбъектовСервер() Экспорт
	...
	Возврат С_АдресныйКлассификаторКлиентСервер.ПроверитьОбновлениеАдресныхОбъектов();
...
Функция ВерсииАдресныхОбъектов() Экспорт
	...
	Возврат С_АдресныйКлассификаторСервер.ВерсииАдресныхОбъектов();
...
Функция ИнформацияПоАдресномуОбъекту(КодАдресногоОбъекта) Экспорт
	...
	Возврат С_АдресныйКлассификаторСервер.ИнформацияПоАдресномуОбъекту(КодАдресногоОбъекта);
...
Функция ПолучитьВерсииАдресныхСведений(ТекстXML) Экспорт
	...
	Возврат С_АдресныйКлассификаторСервер.ПолучитьВерсииАдресныхСведений(ТекстXML);
...
Функция ЗапросРазрешенийБезопасностиПроверкиОбновленияКЛАДР() Экспорт
	//
	//ВладелецРазрешения = ОбщегоНазначения.ИдентификаторОбъектаМетаданных("РегистрСведений.АдресныйКлассификатор_Локализация"); 
	//Разрешения         = АдресныйКлассификатор_Локализация.РазрешенияБезопасностиПроверкиОбновления();
	//
