...
Функция ПроверитьОбновлениеАдресныхОбъектов() Экспорт
	...
	ВерсииХранимыхСведений = С_АдресныйКлассификаторВызовСервера.ВерсииАдресныхОбъектов();
	...
	Для Каждого ЭлементХранимаяВерсия Из ВерсииХранимыхСведений Цикл
		...
		АдресныеСведения = С_АдресныйКлассификаторВызовСервера.ИнформацияПоАдресномуОбъекту(АдресныйОбъект);
...
//	
//	ДоступныеВерсии = АдресныйКлассификаторВызовСервера_Локализация.ПолучитьВерсииАдресныхСведений(ТекстXML);
//	
...
// АдресныйКлассификатор_Локализация с пустым набором значений
//
// Возвращаемое значение:
