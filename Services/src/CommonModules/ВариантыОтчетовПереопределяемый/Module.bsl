...
Разделы.Добавить(Метаданные.Подсистемы.СтандартныеПодсистемы,
   НСтр("ru= 'Отчеты по СтандартныеПодсистемы'"));
 // 
  Разделы.Добавить(Метаданные.Подсистемы.Сервисы,
   НСтр("ru= 'Отчеты по Сервисы'"));	
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	  ...
	  //ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ИмяОтчета); 
 ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.ПраваДоступа);
 ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "");
 ОписаниеВарианта.Описание = НСтр("ru= 'права'");
