...
Функция StatePOST(Запрос)
	...
	Если  Отказ Тогда
		С_ИТССервисыСлужебныеПроцедурыФункции.ДополнитьОписаниеОшибки(ЗаписьXML, "130", "Ошибка поиска сервиса", "Неверно установлены параметры");
   ...
   Иначе		
		...
		Если Отказ Тогда
			С_ИТССервисыСлужебныеПроцедурыФункции.ДополнитьОписаниеОшибки(ЗаписьXML, "130", "Ошибка поиска сервиса",  ОписаниеОшибки);
		Иначе
	...
	С_ИТССервисыСлужебныеПроцедурыФункции.ОтослатьПисьмо("StatusPOST", ТелоЗапроса, СтрокаДляОтвета, "Результат");
	Возврат Ответ;
