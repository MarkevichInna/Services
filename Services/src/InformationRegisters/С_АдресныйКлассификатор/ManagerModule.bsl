...
Процедура ОбновитьСоставСубъектовРФПоКлассификатору() Экспорт
	...
	Запрос = Новый Запрос("
		...
		|	И С_АдресныйКлассификатор.КодАдресногоОбъектаВКоде  = Классификатор.КодСубъектаРФ
		|	И С_АдресныйКлассификатор.КодРайонаВКоде            = 0
		|	И С_АдресныйКлассификатор.КодГородаВКоде            = 0
		|	И С_АдресныйКлассификатор.КодНаселенногоПунктаВКоде = 0
		|	И С_АдресныйКлассификатор.КодУлицыВКоде             = 0
		|ГДЕ
		|	С_АдресныйКлассификатор.Код ЕСТЬ NULL
		|");
	...
	Набор = РегистрыСведений.С_АдресныйКлассификатор.СоздатьНаборЗаписей();
	Отбор = Набор.Отбор;
...
Функция КлассификаторСубъектовРФ() Экспорт
	...
	Макет = РегистрыСведений.С_АдресныйКлассификатор.ПолучитьМакет("КлассификаторАдресныхОбъектовБеларусиОсновной");
...
Функция СведенияОЗагрузкеСубъектовРФ() Экспорт
	...
	Запрос = Новый Запрос("
		...
		|
		|	ВЫБОР
		|		КОГДА 1 В (ВЫБРАТЬ ПЕРВЫЕ 1 1 ИЗ РегистрСведений.С_АдресныйКлассификатор ГДЕ КодАдресногоОбъектаВКоде = ВсеРегионы.КодСубъектаРФ И ТипАдресногоЭлемента = 2) ТОГДА ИСТИНА
		|		КОГДА 1 В (ВЫБРАТЬ ПЕРВЫЕ 1 1 ИЗ РегистрСведений.С_АдресныйКлассификатор ГДЕ КодАдресногоОбъектаВКоде = ВсеРегионы.КодСубъектаРФ И ТипАдресногоЭлемента = 3) ТОГДА ИСТИНА
		|		КОГДА 1 В (ВЫБРАТЬ ПЕРВЫЕ 1 1 ИЗ РегистрСведений.С_АдресныйКлассификатор ГДЕ КодАдресногоОбъектаВКоде = ВсеРегионы.КодСубъектаРФ И ТипАдресногоЭлемента = 4) ТОГДА ИСТИНА
		|		КОГДА 1 В (ВЫБРАТЬ ПЕРВЫЕ 1 1 ИЗ РегистрСведений.С_АдресныйКлассификатор ГДЕ КодАдресногоОбъектаВКоде = ВсеРегионы.КодСубъектаРФ И ТипАдресногоЭлемента = 5) ТОГДА ИСТИНА
		|		КОГДА 1 В (ВЫБРАТЬ ПЕРВЫЕ 1 1 ИЗ РегистрСведений.С_АдресныйКлассификатор ГДЕ КодАдресногоОбъектаВКоде = ВсеРегионы.КодСубъектаРФ И ТипАдресногоЭлемента = 6) ТОГДА ИСТИНА
		|		ИНАЧЕ ЛОЖЬ
		|	КОНЕЦ КАК Загружено
		|ИЗ (
		|
		...
		|		С_АдресныйКлассификатор.КодАдресногоОбъектаВКоде КАК КодСубъектаРФ
		|	ИЗ
		|		РегистрСведений.С_АдресныйКлассификатор КАК С_АдресныйКлассификатор
		|	ГДЕ
		|		С_АдресныйКлассификатор.ТипАдресногоЭлемента        = 1
