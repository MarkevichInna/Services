...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	ПоказатьПредупреждение(, НСтр("ru = 'Требуется указать хотя бы одного получателя'"));
...
Процедура ЗаполнитьПочтовыеАдреса()
	...
	ПараметрыПолучателей.ВидПочтовогоАдресаПолучателей = Справочники.ВидыКонтактнойИнформации.EmailПользователя;
