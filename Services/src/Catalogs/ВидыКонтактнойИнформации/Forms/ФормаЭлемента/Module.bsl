...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.ЗапретитьРедактированиеПользователем Тогда
...
&НаКлиенте
Процедура ЗапрещатьВводНекорректногоПриИзменении(Элемент)
	ОтобразитьДоступностьВариантовПроверкиПоКлассификатору();
КонецПроцедуры
...
Процедура ПроверятьПоКлассификаторуПриИзменении(Элемент)
	Если ПроверятьПоКлассификатору = 0 Тогда
		Объект.ПроверятьПоФИАС = Истина;
		Объект.ПроверятьКорректность = Истина;
	Иначе
		Объект.ПроверятьПоФИАС = Ложь;
		Объект.ПроверятьКорректность = Истина;
	КонецЕсли;
КонецПроцедуры
...
Процедура ОтобразитьДоступностьВариантовПроверкиПоКлассификатору()
	Если Объект.ЗапрещатьВводНекорректного Тогда
...
Процедура ИзменитьОтображениеПриИзмененииТолькоРоссии()
	...
	Элементы.ПроверятьПоКлассификатору.Доступность   = Объект.ЗапрещатьВводНекорректного;
	Элементы.ЗапрещатьВводНекорректного.Доступность   = Объект.АдресТолькоРоссийский;
